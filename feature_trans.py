...
#基准月
import datetime
# historical_transactions['purchase_date'] = historical_transactions['purchase_date'].apply()
...
train['target'] = target
train.to_csv(out_dir+'train_trans1229.csv',index=False)
test.to_csv(out_dir+'test_trans1229.csv',index=False)
